---
title: "Avoiding or Hiding Tableau filters - Part I"
...
When it comes to Tableau Dashboards, I am known as a filter-hater within my team. I find them ugly and not very user friendly. That's why I always try to find new ways to avoid, hide or just make filters more user-friendly.
...
* __Consider Highlighting.__ Sometimes Highlighting is enough and there is no real need for filters
  ...
  <img src="Highlight State.png" width="500">
...
<img src="List of options.png" width="500">

* __Use icons.__ Similar to the previous option but more user friendly, you can show icons to click on as filters.
<img src="\static\img\Filter with icon.png" width="500">

![optional caption text](../../static/img/filters1.png)
